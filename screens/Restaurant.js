            ...
            >
                {
                    restaurant?.menu.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                <Text style={{ top:'70%', marginVertical: 10, textAlign:'center' }}>{item.name} - {item.price.toFixed(2)}</Text>
                                <Text style={{top:'60%'}}>{item.description}</Text>
                            </View>
                            ...
                            >
                                ...
                                <Text style={{ top:'10%', color: COLORS.darkgray }}>{item.calories.toFixed(2)} cal</Text>
                            </View>
                        </View>
                    ))
                }
